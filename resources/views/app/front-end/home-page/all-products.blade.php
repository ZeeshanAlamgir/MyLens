...
<style>
    ...
    @media(max-width: 767px){
        .custom_filter_col-12{
            width: 100% !important;
        }
        .custom_filter_col-12 .row{
    ...
    <section class="collection_section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-12 pt-3 custom_filter_col-12" style="width: auto;">
                        ...
                        {{-- <form action="{{ route('clear.filters') }}" method="GET"> --}}
                            <div class="row d-flex">
                                <div class="col-md-5" style="width: auto;">
                                    <span class="by_online_btn ps-2 pe-2 pt-3 pb-3"  onclick="history.back()" style="cursor: pointer">&nbsp;&nbsp;<i class="fa fa-times pe-1" aria-hidden="true"></i> Go Back &nbsp;&nbsp;</span>
                                </div>
