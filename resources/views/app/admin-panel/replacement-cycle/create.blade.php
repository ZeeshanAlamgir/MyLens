...
@section('page-title', 'Create Replacement Cycle')
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Create Replacement Cycle</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('replacement-cylce.create') }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    <div class="card">
        <form action="{{route('replacement-cylce.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                @csrf
                {{ view('app.admin-panel.replacement-cycle.form-fields') }}
            </div>

            <div class="card-footer d-flex align-items-center justify-content-end">
                <button type="submit" class="btn btn-relief-outline-success waves-effect waves-float waves-light me-1">
                    <i data-feather='save'></i>
                    Save Replacement Cycle
                </button>
...
<script>
    ...
    $(document).on('submit','#replacement_cycle__form',function(e){
        e.preventDefault();
        let data = new FormData(this);
        $.ajax({
            type: "post",
            url: "{{route('replacement-cylce.store')}}",
            data: data,
            dataType: "json",
            contentType: false,
            processData: false,
            ...
            success: function (response) {
                ...
                {
                    toastr.success('Replacement Cycle Added Successfully.');
