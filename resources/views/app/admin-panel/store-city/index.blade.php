...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'city.index') }}
@endsection
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form id="stores-city-datatable" action="{{ route('city.delete')}}" method="get">
                {{ $dataTable->table() }}
            </form>
        </div>
    </div>
...
<script>
    ...
    {
        location.href = "{{ route('city.create') }}";
    }
