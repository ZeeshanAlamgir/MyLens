...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'store.index') }}
@endsection
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form id="stores-datatable" action="{{ route('store.destroy')}}" method="get">
                {{ $dataTable->table() }}
            </form>
        </div>
    </div>
...
<script>
    ...
    {
        location.href = "{{ route('store.create') }}";
    }
