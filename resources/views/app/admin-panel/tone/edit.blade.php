...
@section('page-title', 'Update Tone')
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Update Tone</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('tone.edit', $tone['id']) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    <div class="card">
        <form id="tone_update__form">
            ...
            <div class="card-body">
                @csrf
                {{ view('app.admin-panel.tone.form-fields',['tone'=>$tone]) }}
            </div>
...
<script>
    ...
    $(document).on('submit','#tone_update__form',function(e){
        e.preventDefault();
        let data = $(this).serialize();
        let id = {{$tone->id}};
        $.ajax({
            type: "post",
            url: "{{url('admin/tone/update')}}/"+id,
            data: data,
            dataType: "json",
            beforeSend : function(){
            ...
            success: function (response) {
                ...
                {
                    toastr.success('Tone Updated Successfully.');
