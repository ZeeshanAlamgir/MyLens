...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Create Collection</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('collection.create') }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    <div class="card">
        <form action="{{route('collection.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                @csrf
                {{ view('app.admin-panel.collections.form-fields') }}
            </div>
...
<script>
    ...
    $(document).on('submit','#collection_form',function(e){
        e.preventDefault();
