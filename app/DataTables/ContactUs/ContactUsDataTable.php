...
namespace App\DataTables\ContactUs;
...
class ContactUsDataTable extends DataTable
{
    ...
    protected function getColumns(): array
    {
        $colArray = [
            ...
            Column::make('full_name')->title('Name')->searchable(true),
            Column::make('email')->title('Phone No')->searchable(true),
            Column::make('shop_name')->title('Shop')->searchable(true),
            Column::make('city_name')->title('City')->searchable(true),
            Column::make('subject')->title('Subject')->searchable(true),
            Column::make('message')->title('Message')->searchable(true),
