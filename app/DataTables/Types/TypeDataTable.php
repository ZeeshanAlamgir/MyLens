...
namespace App\DataTables\Types;
...
class TypeDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('image', function ($row) {
                return view('app.admin-panel.types.image', ['id' => $row->id]);
            })
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.types.action', ['id' => $row->id]);
            })
            ->setRowId('id')
        ...
        return $this->builder()
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create New Type')->attr([
    ...
    protected function getColumns(): array
    {
        $colArray = [
            ...
            Column::make('image')->searchable(true)->title('Image'),
