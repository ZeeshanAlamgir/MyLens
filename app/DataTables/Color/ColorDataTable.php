...
namespace App\DataTables\Color;
...
class ColorDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.colors.action', ['id' => $row->id]);
            })
            ->editColumn('banner', function ($row) {
                return view('app.admin-panel.colors.banner', ['id' => $row->id]);
            })
            ->editColumn('image', function ($row) {
                return view('app.admin-panel.colors.image', ['id' => $row->id]);
            })
            ->setRowId('id')
        ...
        return $this->builder()
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create New Color')->attr([
    ...
    protected function getColumns(): array
    {
        $colArray = [
            ...
            Column::make('banner')->title('Banner')->orderable(false)->searchable(true),
