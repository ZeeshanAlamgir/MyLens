...
class StyleDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('image', function ($row) {
                return view('app.admin-panel.styles.image', ['id' => $row->id]);
            })
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.styles.action', ['id' => $row->id]);
            })
            ->setRowId('id')
    ...
    public function query(Style $model): QueryBuilder
    {
        ...
        return $this->builder()
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create New Style')->attr([
    ...
    protected function getColumns(): array
    {
        $colArray = [
            ...
            Column::make('label')->searchable(true)->title('Label'),
            Column::make('image')->searchable(false)->orderable(false)->title('Image'),
