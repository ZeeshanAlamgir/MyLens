...
namespace App\DataTables\StoreCity;
...
class StoreCityDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.store-city.action', ['id' => $row->id]);
            })
            ->setRowId('id')
    ...
    public function query(StoreCity $model): QueryBuilder
    {
        ...
        return $this->builder()
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create City')->attr([
    ...
    protected function getColumns(): array
    {
        $colArray = [
            ...
            Column::make('name')->searchable(true)->title('City'),
