...
class DistributorDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.distributors.action', ['id' => $row->id]);
            })
            ->editColumn('image', function ($row) {
                return view('app.admin-panel.distributors.image', ['id' => $row->id]);
            })
            ->setRowId('id')
        ...
        return $this->builder()
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create New Distributor')->attr([
                        'onclick' => 'createNewDistributor()',
                    ]),
            )
    ...
    protected function getColumns(): array
    {
        $colArray = [
            ...
            Column::make('image')->title('Flag')->orderble(false)->searchable(false),
