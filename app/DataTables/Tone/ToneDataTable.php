...
class ToneDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.tone.action', ['id' => $row->id]);
            })
            ->setRowId('id')
    ...
    public function query(Tone $model): QueryBuilder
    {
        ...
        return $this->builder()
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create New Tone')->attr([
                        'onclick' => 'createNewTone()',
                    ]),
            )
