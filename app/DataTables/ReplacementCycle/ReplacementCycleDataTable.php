...
namespace App\DataTables\ReplacementCycle;
...
class ReplacementCycleDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.replacement-cycle.action', ['id' => $row->id]);
            })
            ->editColumn('image', function ($row) {
                return view('app.admin-panel.replacement-cycle.image', ['id' => $row->id]);
            })
            ->setRowId('id')
    ...
    public function query(ReplacementCycle $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
            ->setTableId("replacment_cycle-table")
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create New Replacement Cycle')->attr([
                        'onclick' => 'createNewReplacementCycle()',
                    ]),
            )
    ...
    protected function getColumns(): array
    {
        $colArray = [
            ...
            Column::make('name')->searchable(true)->title('Replacement Cycle'),
            Column::make('image')->orderable(false)->searchable(false)->title('Image'),
