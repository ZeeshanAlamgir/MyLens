...
class BannerDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.banner.action', ['id' => $row->id]);
            })
            ->editColumn('banner', function ($row) {
                return view('app.admin-panel.banner.image', ['id' => $row->id]);
            })
            ->setRowId('id')
        ...
        return $this->builder()
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create New Banner')->attr([
    ...
    protected function getColumns(): array
    {
        $colArray = [
            ...
            Column::make('created_at')->title('Created AT')->orderable(false)->searchable(false),
        ];
