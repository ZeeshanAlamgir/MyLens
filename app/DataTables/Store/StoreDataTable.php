    ...
    public function dataTable(QueryBuilder $query)
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('city_id', function ($row) {
                return $row->city_id ? $row->store_cities->name : '';
            })
            ->editColumn('actions', function ($row) {
                return view('app.admin-panel.stores.action', ['id' => $row->id]);
            })
            ->setRowId('id')
            ->rawColumns(array_merge($columns, ['actions', 'check','city_id']));
    }
        ...
        return $this->builder()
            ...
            ->buttons(
                ...
                Button::raw('create-new')
                    ...
                    ->text('<i class="bi bi-plus"></i> Create New Store')->attr([
